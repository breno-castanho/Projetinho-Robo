...
nome_arquivo_csv = r'C:/Users/breno.castanho/Documents/Projetinho/breno.csv'


nome_arquivo_json = 'breno.json'
...
def extrair_e_exibir_dados(nome_arquivo_json):
    """
    Função para extrair e exibir dados específicos do arquivo JSON.
    """
